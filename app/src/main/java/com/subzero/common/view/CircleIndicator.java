...
public class CircleIndicator extends LinearLayout implements OnPageChangeListener
{
	...
	private int mAnimatorResId = R.animator.circleindicator_scale_with_alpha;
	private int mAnimatorReverseResId = -1;
	private int mIndicatorBackground = R.drawable.circleindicator_white_radius;
	private int mIndicatorUnselectedBackground = R.drawable.circleindicator_white_radius;
	...
	private void handleTypedArray(Context context, AttributeSet attrs)
	{
		if (attrs != null)
		{
			...
			mAnimatorResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_animator, R.animator.circleindicator_scale_with_alpha);
			mAnimatorReverseResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_animator_reverse, -1);
			mIndicatorBackground = typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable, R.drawable.circleindicator_white_radius);
			mIndicatorUnselectedBackground = typedArray.getResourceId(R.styleable.CircleIndicator_ci_drawable_unselected, mIndicatorBackground);
			typedArray.recycle();
		}
