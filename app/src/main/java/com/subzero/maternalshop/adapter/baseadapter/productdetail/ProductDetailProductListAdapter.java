 ...
 * */
public class ProductDetailProductListAdapter extends BaseAdapter
{
	protected List<ProductBean> list;
	protected Context context;
	public ProductDetailProductListAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		ViewUtil.setText2TextView(holder.tvSalesVolume, list.get(position).goods_number);
